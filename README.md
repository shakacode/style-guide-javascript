...
* Bind callbacks passed to react components with lodash's `_.bindAll` function in the constructor unless you need to bind additional parameters. In that case, you can call `_.bind` when rendering.
